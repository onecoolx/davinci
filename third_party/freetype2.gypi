...

{
  ...
  'sources': [
    ...
    '<(lib_dir)/src/autofit/afangles.c',
    '<(lib_dir)/src/autofit/afblue.c',
    '<(lib_dir)/src/autofit/afcjk.c',
    '<(lib_dir)/src/autofit/afdummy.c',
    '<(lib_dir)/src/autofit/afglobal.c',
    '<(lib_dir)/src/autofit/afhints.c',
    '<(lib_dir)/src/autofit/afindic.c',
    '<(lib_dir)/src/autofit/aflatin.c',
    '<(lib_dir)/src/autofit/aflatin2.c',
    '<(lib_dir)/src/autofit/afloader.c',
    '<(lib_dir)/src/autofit/afmodule.c',
    '<(lib_dir)/src/autofit/afpic.c',
    '<(lib_dir)/src/autofit/afranges.c',
    '<(lib_dir)/src/autofit/afwarp.c',
    '<(lib_dir)/src/autofit/autofit.c',
    '<(lib_dir)/src/autofit/hbshim.c',
  ],
  'conditions': [
    ['OS=="win"', {
      'sources': [
