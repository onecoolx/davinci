...
ExternalProject_Add(
  ...
  PATCH_COMMAND ${CMAKE_COMMAND} -E copy
    "${PROJECT_ROOT}/packages/patchs/${HARFBUZZ_NAME}-${HARFBUZZ_VERSION}/CMakeLists.txt" "${PROJECT_OUT}/${HARFBUZZ_NAME}/src/${HARFBUZZ_NAME}/"
  BUILD_IN_SOURCE
  CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DHB_HAVE_FREETYPE=ON -DHB_HAVE_ICU=ON -DHB_HAVE_UNISCRIBE=ON -DHB_HAVE_DIRECTWRITE=ON -DCMAKE_INSTALL_PREFIX=${PROJECT_OUT}
)
include_directories(${PROJECT_OUT}/include)
link_directories(${PROJECT_OUT}/lib)

add_dependencies(${HARFBUZZ_NAME} ${ICU_NAME} ${FREETYPE_NAME})
