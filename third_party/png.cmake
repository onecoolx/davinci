...
ExternalProject_Add(
  ...
  BUILD_IN_SOURCE
  CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DPNG_TESTS=OFF -DPNG_TOOLS=OFF -DZLIB_ROOT=${PROJECT_OUT}/${ZLIB_NAME}/src/${ZLIB_NAME}-build -DCMAKE_INSTALL_PREFIX=${PROJECT_OUT}
)
