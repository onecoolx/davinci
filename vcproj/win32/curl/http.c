...
/* Special for china mobile cmwap */
#define CHINAMOBILE_CMWAP 1
...
#ifdef CHINAMOBILE_CMWAP

  return CURLE_OK;  // for chinamobile cmwap proxy, it not used connect to proxy!
#else
