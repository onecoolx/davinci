...
namespace WebCore {
    ...
    public:
        ...
        void setWindowFeature(const WindowFeatures&)const;
        ...
        bool locationbarVisible() const;
        bool personalbarVisible() const;
        ...
        void setToolTip(const HitTestResult&, const IntPoint&);
