...
JSSVGStringList::JSSVGStringList(ExecState* exec, SVGStringList* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
JSValue* JSSVGStringListPrototypeFunction::callAsFunction(ExecState* exec, JSObject* thisObj, const List& args)
{
    ...
    JSSVGStringList* castedThisObj = static_cast<JSSVGStringList*>(thisObj);
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGStringList* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGStringList, JSSVGStringList>(exec, obj, context);
}
