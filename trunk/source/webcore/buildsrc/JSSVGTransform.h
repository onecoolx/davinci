...
public:
    JSSVGTransform(KJS::ExecState*, JSSVGPODTypeWrapper<SVGTransform>*, SVGElement* context);
...
KJS::JSValue* toJS(KJS::ExecState*, JSSVGPODTypeWrapper<SVGTransform>*, SVGElement* context);
