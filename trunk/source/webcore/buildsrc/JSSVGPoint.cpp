...
JSSVGPoint::JSSVGPoint(ExecState* exec, JSSVGPODTypeWrapper<FloatPoint>* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
JSValue* JSSVGPointPrototypeFunction::callAsFunction(ExecState* exec, JSObject* thisObj, const List& args)
{
    ...
    JSSVGPoint* castedThisObj = static_cast<JSSVGPoint*>(thisObj);
    ...
    case JSSVGPoint::MatrixTransformFuncNum: {
        ...
        KJS::JSValue* result = toJS(exec, new JSSVGPODTypeWrapperCreatorReadOnly<FloatPoint>(imp.matrixTransform(matrix)), castedThisObj->context());
...
KJS::JSValue* toJS(KJS::ExecState* exec, JSSVGPODTypeWrapper<FloatPoint>* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<JSSVGPODTypeWrapper<FloatPoint>, JSSVGPoint>(exec, obj, context);
}
