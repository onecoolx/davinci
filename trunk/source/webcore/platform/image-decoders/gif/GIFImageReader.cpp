  ...
  for (;len >= bytes_to_consume; q=buf) {
    ...
    case gif_control_extension:
    {
      ...
      if (frame_reader) {
        ...
        frame_reader->disposal_method = (WebCore::PixelsBuffer::FrameDisposalMethod)(((*q) >> 2) & 0x7);
        // Some specs say 3rd bit (value 4), other specs say value 3
        // Let's choose 3 (the more popular)
        if (frame_reader->disposal_method == 4)
          frame_reader->disposal_method = WebCore::PixelsBuffer::DisposeOverwritePrevious;
