...
JSSVGRenderingIntent::JSSVGRenderingIntent(ExecState* exec, SVGRenderingIntent* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGRenderingIntent* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGRenderingIntent, JSSVGRenderingIntent>(exec, obj, context);
}
