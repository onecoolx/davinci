...
class JSSVGFEBlendElementPrototypeFunction : public KJS::InternalFunctionImp {
public:
    JSSVGFEBlendElementPrototypeFunction(KJS::ExecState* exec, int i, int len, const KJS::Identifier& name)
