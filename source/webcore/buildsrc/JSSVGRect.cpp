...
JSSVGRect::JSSVGRect(ExecState* exec, JSSVGPODTypeWrapper<FloatRect>* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
JSSVGRect::~JSSVGRect()
{
    JSSVGPODTypeWrapperCache<FloatRect, SVGAnimatedRect>::forgetWrapper(m_impl.get());
...
KJS::JSValue* toJS(KJS::ExecState* exec, JSSVGPODTypeWrapper<FloatRect>* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<JSSVGPODTypeWrapper<FloatRect>, JSSVGRect>(exec, obj, context);
}
