...
{
    { "getPresentationAttribute", JSSVGPolygonElement::GetPresentationAttributeFuncNum, DontDelete|Function, 1, 0 },
    { "hasExtension", JSSVGPolygonElement::HasExtensionFuncNum, DontDelete|Function, 1, 0 },
    ...
    { "getBBox", JSSVGPolygonElement::GetBBoxFuncNum, DontDelete|Function, 0, 0 }
};

static const HashTable JSSVGPolygonElementPrototypeTable = 
{
    2, 6, JSSVGPolygonElementPrototypeTableEntries, 6
};
...
JSValue* JSSVGPolygonElementPrototypeFunction::callAsFunction(ExecState* exec, JSObject* thisObj, const List& args)
{
    ...
    JSSVGPolygonElement* castedThisObj = static_cast<JSSVGPolygonElement*>(thisObj);
