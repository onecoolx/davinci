...
{
    { "getPresentationAttribute", JSSVGPolylineElement::GetPresentationAttributeFuncNum, DontDelete|Function, 1, 0 },
    { "hasExtension", JSSVGPolylineElement::HasExtensionFuncNum, DontDelete|Function, 1, 0 },
    ...
    { "getBBox", JSSVGPolylineElement::GetBBoxFuncNum, DontDelete|Function, 0, 0 }
};

static const HashTable JSSVGPolylineElementPrototypeTable = 
{
    2, 6, JSSVGPolylineElementPrototypeTableEntries, 6
};
...
JSValue* JSSVGPolylineElementPrototypeFunction::callAsFunction(ExecState* exec, JSObject* thisObj, const List& args)
{
    ...
    JSSVGPolylineElement* castedThisObj = static_cast<JSSVGPolylineElement*>(thisObj);
