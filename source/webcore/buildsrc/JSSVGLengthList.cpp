...
JSSVGLengthList::JSSVGLengthList(ExecState* exec, SVGLengthList* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGLengthList* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGLengthList, JSSVGLengthList>(exec, obj, context);
}
