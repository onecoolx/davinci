...
JSSVGAnimatedEnumeration::JSSVGAnimatedEnumeration(ExecState* exec, SVGAnimatedEnumeration* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGAnimatedEnumeration* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGAnimatedEnumeration, JSSVGAnimatedEnumeration>(exec, obj, context);
}
