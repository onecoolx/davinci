...
public:
    JSSVGNumber(KJS::ExecState*, JSSVGPODTypeWrapper<float>*, SVGElement* context);
    virtual ~JSSVGNumber();
...
KJS::JSValue* toJS(KJS::ExecState*, JSSVGPODTypeWrapper<float>*, SVGElement* context);
float toSVGNumber(KJS::JSValue*);
