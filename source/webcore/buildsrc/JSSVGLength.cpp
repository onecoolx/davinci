...
{
    JSSVGPODTypeWrapperCache<SVGLength, SVGAnimatedLength>::forgetWrapper(m_impl.get());
...
KJS::JSValue* toJS(KJS::ExecState* exec, JSSVGPODTypeWrapper<SVGLength>* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<JSSVGPODTypeWrapper<SVGLength>, JSSVGLength>(exec, obj, context);
}
