...
JSSVGAnimatedPreserveAspectRatio::JSSVGAnimatedPreserveAspectRatio(ExecState* exec, SVGAnimatedPreserveAspectRatio* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGAnimatedPreserveAspectRatio* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGAnimatedPreserveAspectRatio, JSSVGAnimatedPreserveAspectRatio>(exec, obj, context);
}
