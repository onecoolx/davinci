...
struct GIFFrameReader {
    ...
    WebCore::PixelsBuffer::FrameDisposalMethod disposal_method;   /* Restore to background, leave in place, etc.*/
    ...
    GIFFrameReader() {
        ...
        tpixel = 0;
        disposal_method = WebCore::PixelsBuffer::DisposeNotSpecified;
