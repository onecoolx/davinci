...
JSSVGNumber::JSSVGNumber(ExecState* exec, JSSVGPODTypeWrapper<float>* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
KJS::JSValue* toJS(KJS::ExecState* exec, JSSVGPODTypeWrapper<float>* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<JSSVGPODTypeWrapper<float>, JSSVGNumber>(exec, obj, context);
}
float toSVGNumber(KJS::JSValue* val)
{
    return val->isObject(&JSSVGNumber::info) ? (float) *static_cast<JSSVGNumber*>(val)->impl() : 0;
}
