...
JSSVGAngle::JSSVGAngle(ExecState* exec, SVGAngle* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
JSValue* JSSVGAnglePrototypeFunction::callAsFunction(ExecState* exec, JSObject* thisObj, const List& args)
{
    ...
    JSSVGAngle* castedThisObj = static_cast<JSSVGAngle*>(thisObj);
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGAngle* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGAngle, JSSVGAngle>(exec, obj, context);
}
