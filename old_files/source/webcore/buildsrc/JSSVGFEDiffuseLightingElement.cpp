...
{
    { "getPresentationAttribute", JSSVGFEDiffuseLightingElement::GetPresentationAttributeFuncNum, DontDelete|Function, 1, 0 }
};
...
{
    return getStaticFunctionSlot<JSSVGFEDiffuseLightingElementPrototypeFunction, JSObject>(exec, &JSSVGFEDiffuseLightingElementPrototypeTable, this, propertyName, slot);
}
...
JSValue* JSSVGFEDiffuseLightingElementPrototypeFunction::callAsFunction(ExecState* exec, JSObject* thisObj, const List& args)
{
    if (!thisObj->inherits(&JSSVGFEDiffuseLightingElement::info))
      return throwError(exec, TypeError);

    JSSVGFEDiffuseLightingElement* castedThisObj = static_cast<JSSVGFEDiffuseLightingElement*>(thisObj);
