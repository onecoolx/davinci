...
JSSVGAnimatedLengthList::JSSVGAnimatedLengthList(ExecState* exec, SVGAnimatedLengthList* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGAnimatedLengthList* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGAnimatedLengthList, JSSVGAnimatedLengthList>(exec, obj, context);
}
