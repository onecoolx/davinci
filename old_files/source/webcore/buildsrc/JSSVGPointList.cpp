...
JSSVGPointList::JSSVGPointList(ExecState* exec, SVGPointList* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
JSValue* JSSVGPointListPrototypeFunction::callAsFunction(ExecState* exec, JSObject* thisObj, const List& args)
{
    ...
    JSSVGPointList* castedThisObj = static_cast<JSSVGPointList*>(thisObj);
    SVGPointList* imp = static_cast<SVGPointList*>(castedThisObj->impl());
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGPointList* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGPointList, JSSVGPointList>(exec, obj, context);
}
