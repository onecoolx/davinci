...
class JSSVGFETileElementPrototypeFunction : public KJS::InternalFunctionImp {
public:
    JSSVGFETileElementPrototypeFunction(KJS::ExecState* exec, int i, int len, const KJS::Identifier& name)
