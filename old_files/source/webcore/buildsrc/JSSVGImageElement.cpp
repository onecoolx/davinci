...
{
    { "getPresentationAttribute", JSSVGImageElement::GetPresentationAttributeFuncNum, DontDelete|Function, 1, 0 },
    { "hasExtension", JSSVGImageElement::HasExtensionFuncNum, DontDelete|Function, 1, 0 },
    ...
    { "getBBox", JSSVGImageElement::GetBBoxFuncNum, DontDelete|Function, 0, 0 }
};

static const HashTable JSSVGImageElementPrototypeTable = 
{
    2, 6, JSSVGImageElementPrototypeTableEntries, 6
};
...
JSValue* JSSVGImageElementPrototypeFunction::callAsFunction(ExecState* exec, JSObject* thisObj, const List& args)
{
    ...
    JSSVGImageElement* castedThisObj = static_cast<JSSVGImageElement*>(thisObj);
