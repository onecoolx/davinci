...
public:
    JSSVGLength(KJS::ExecState*, JSSVGPODTypeWrapper<SVGLength>*, SVGElement* context);
    virtual ~JSSVGLength();
...
KJS::JSValue* toJS(KJS::ExecState*, JSSVGPODTypeWrapper<SVGLength>*, SVGElement* context);
