...
JSSVGAnimatedTransformList::JSSVGAnimatedTransformList(ExecState* exec, SVGAnimatedTransformList* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGAnimatedTransformList* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGAnimatedTransformList, JSSVGAnimatedTransformList>(exec, obj, context);
}
