...
JSSVGAnimatedNumber::JSSVGAnimatedNumber(ExecState* exec, SVGAnimatedNumber* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGAnimatedNumber* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGAnimatedNumber, JSSVGAnimatedNumber>(exec, obj, context);
}
