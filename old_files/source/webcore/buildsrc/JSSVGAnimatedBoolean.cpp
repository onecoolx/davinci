...
JSSVGAnimatedBoolean::JSSVGAnimatedBoolean(ExecState* exec, SVGAnimatedBoolean* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGAnimatedBoolean* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGAnimatedBoolean, JSSVGAnimatedBoolean>(exec, obj, context);
}
