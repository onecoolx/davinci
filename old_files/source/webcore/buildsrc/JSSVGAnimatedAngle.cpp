...
JSSVGAnimatedAngle::JSSVGAnimatedAngle(ExecState* exec, SVGAnimatedAngle* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGAnimatedAngle* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGAnimatedAngle, JSSVGAnimatedAngle>(exec, obj, context);
}
