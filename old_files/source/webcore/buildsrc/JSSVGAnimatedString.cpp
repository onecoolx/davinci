...
JSSVGAnimatedString::JSSVGAnimatedString(ExecState* exec, SVGAnimatedString* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
KJS::JSValue* toJS(KJS::ExecState* exec, SVGAnimatedString* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGAnimatedString, JSSVGAnimatedString>(exec, obj, context);
}
