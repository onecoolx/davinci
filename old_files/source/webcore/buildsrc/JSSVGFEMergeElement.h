...
class JSSVGFEMergeElementPrototypeFunction : public KJS::InternalFunctionImp {
public:
    JSSVGFEMergeElementPrototypeFunction(KJS::ExecState* exec, int i, int len, const KJS::Identifier& name)
