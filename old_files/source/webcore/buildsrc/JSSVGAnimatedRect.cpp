...
JSSVGAnimatedRect::JSSVGAnimatedRect(ExecState* exec, SVGAnimatedRect* impl, SVGElement* context)
    : m_context(context)
    , m_impl(impl)
{
...
JSValue* JSSVGAnimatedRect::getValueProperty(ExecState* exec, int token) const
{
    ...
    case BaseValAttrNum: {
        ...
        return toJS(exec, JSSVGPODTypeWrapperCache<FloatRect, SVGAnimatedRect>::lookupOrCreateWrapper(imp, &SVGAnimatedRect::baseVal, &SVGAnimatedRect::setBaseVal), context());
    }
    case AnimValAttrNum: {
        SVGAnimatedRect* imp = static_cast<SVGAnimatedRect*>(impl());

        return toJS(exec, JSSVGPODTypeWrapperCache<FloatRect, SVGAnimatedRect>::lookupOrCreateWrapper(imp, &SVGAnimatedRect::animVal, &SVGAnimatedRect::setAnimVal), context());
    }
    }
    return 0;
}

KJS::JSValue* toJS(KJS::ExecState* exec, SVGAnimatedRect* obj, SVGElement* context)
{
    return KJS::cacheSVGDOMObject<SVGAnimatedRect, JSSVGAnimatedRect>(exec, obj, context);
}
